...
<!--                
                ...
                <app-green>
                    <p slot="greenText">{{ greenText }}</p>
                </app-green>
                <app-red>
                    <p slot="redText">{{ redText }}</p>
                </app-red>
-->
            </div>
        </div>
