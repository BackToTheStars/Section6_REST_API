...
c.font = "20px Arial";
c.fillStyle = "black";
c.fillText("This will allow to create new types of", xT, yT);
c.fillText("nuclear and conventional weapons ", xT, yT+1*yTextSpacer);
c.fillText("against Russia and China, protected", xT, yT+2*yTextSpacer);
c.fillText("from radio jamming.", xT, yT+3*yTextSpacer);
